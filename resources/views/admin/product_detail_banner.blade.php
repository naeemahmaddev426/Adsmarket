    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{ route('admin.product_detail_banner') }}">product_detail_banner</a></li>
        </ol>
      </nav>
    </div>
    <div class="container">
        ...
        @endif
          ...
          @endif
          <div class="card p-5">
            <form action="{{ route('admin.upload_product_detail_banner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mb-3">
                    <label for="banner">Upload Product detail Banner</label>
