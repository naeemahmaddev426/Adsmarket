                    ...
                    <div class="card-body">
                        <h5 class="card-title">{{ ucfirst($category) }} Detail <span> | Today</span></h5>
                            ...
                            <table class="table table-borderless datatable">
                                <thead>
                                <tr>
                                    <th>Mobiles Category Details</th>
                                </tr>
                                </thead>
                                <tbody>
                                @forelse ($ads as $ad)
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-md-2" style="padding: 0;">
                                                        @if($ad->images->count() > 1)
                                                            ...
                                                            <div class="swiper-main-container swiper-main-{{ $ad->id }} mx-auto" style="height: 100px; width: 180px; overflow: hidden;">
                                                                <div class="swiper-wrapper">
                                                                    @if ($ad->images && $ad->images->isNotEmpty())
                                                                        @foreach ($ad->images as $image)
                                                                            <div class="swiper-slide">
                                                                                <img src="{{ asset($image->image_path) }}" class="img-fluid lazyload" alt="Ad Image" style="height: 100px; max-width: 100%; object-fit: cover;">
                                                                            </div>
                                                                        @endforeach
                                                                    @else
                                                                        <div class="swiper-slide">
                                                                            <img src="{{ asset('assets/images/empty-300x240.jpg') }}" class="img-fluid" alt="No Image Available" style="height: 100px; max-width: 100%; object-fit: cover;">
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!-- Thumbnail Swiper -->
                                                            <div class="swiper-thumbs-container swiper-thumbs-{{ $ad->id }} mx-auto" style="height: fit-content;max-width: 100%; overflow: hidden; margin-top: 5px;">
                                                                <div class="swiper-wrapper">
                                                                    @if ($ad->images && $ad->images->isNotEmpty())
                                                                        @foreach ($ad->images as $image)
                                                                            <div class="swiper-slide border m-2" style="width: auto; cursor: pointer;">
                                                                                <img src="{{ asset($image->image_path) }}" class="img-fluid lazyload" alt="Thumbnail" style="height: 30px; max-width: 100%; object-fit: cover;">
                                                                            </div>
                                                                        @endforeach
                                                                    @else
                                                                        <div class="swiper-slide">
                                                                            <img src="{{ asset('assets/images/empty-300x240.jpg') }}" class="img-fluid" alt="No Thumbnail Available" style="height: 50px; max-width: 100%; object-fit: cover;">
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            @else
                                                            @foreach($ad->images as $image)
                                                                <img src="{{ asset($image->image_path) }}" alt="Ad Image" class="img-fluid mx-auto" style="height: fit-content; width: auto;" />
                                                            @endforeach
                                                        @endif
                                                    </div>
