		...
		<div class="row">
			...
			<div class="col-lg-12 col-12 col-md-12 mx-auto mb-5">
				<div class="top-bar bg-light pb-2">
					<div class="logo">
						<a href="/post_ad" class="home-link me-4 text-decoration-none text-dark">
					...
					<form method="POST" action="{{ route('store') }}" enctype="multipart/form-data">
						...
						<div class="row pb-3">
							<div class="col-md-9">
								<div class="bread d-flex">
									...
									<a href="/post_ad" class="text-decoration-none text-dark"><button type="button"
											class=" ms-3 bg-transparent  change-attribute"
											style="font-size: 14px;">Change</button>
									</a>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<x-input_title type="text" name="title" class="form-control" value="{{ old('title') }}"
									required />
								@error('title')
								<span class="text-danger">{{ $message }}</span>
								@enderror
								<x-label_title for="description" class="label-span text-wrap">Description</x-label_title>
								<x-textarea_dec id="description" name="description" spellcheck="false"
									class="form-control" rows="6" autocomplete="nope"
									value="{{ old('description') }}" required />
								@error('description')
								<span class="text-danger">{{ $message }}</span>
								@enderror

								<div id="{{ $sub_cat == $subCategories[0]->sub_category_name ? $sub_cat : $subCategories[0]->sub_category_name  }}"
									class="component">
										<!-- tablets  -->
									<x-label_title for="title" class="label-span">Brand</x-label_title>
									<x-brand_input name="brand"
										:options="['Apple', 'Samsung', 'Other Tablets', 'Lenovo', 'Huawei', 'Others', 'Dany Tabs', 'Amazon', 'Asus', 'Dell', 'Alcatel', 'Huion']" />
									@error('brand')
									<div class="alert alert-danger">{{ $message }}</div>
									@enderror
									<x-label_title for="title" class="label-span">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-10','use' => 'option-11','Open Box' => 'option-12','Refurbished' => 'option-13','For Part or Not Working' => 'option-14', ]" />
								</div>
								<div id="{{ $sub_cat == $subCategories[2]->sub_category_name ? $sub_cat : $subCategories[2]->sub_category_name  }}"
									class="component">
									<!-- smart watch  -->
								...
								<div id="{{ $sub_cat == $subCategories[4]->sub_category_name ? $sub_cat : $subCategories[4]->sub_category_name  }}"
									class="component">
									<!--  car  -->
									<x-label_title for="title" class="label-span mt-4">Make</x-label_title>
									<x-brand_input name="make_car"
										:options="['Suzuki', 'Toyota', 'Honda', 'Daihatsu', 'Adam', 'Audi', 'BAIC', 'Bentley', 'BMW', 'Buick', 'Cadilac', 'Changan']"
										class="border form-control" />
								</div>
								...
								<div id="{{ $sub_cat == $subCategories[7]->sub_category_name ? $sub_cat : $subCategories[7]->sub_category_name  }}"
									...
									<x-condition_tablets_five name="type"
										:options="['Car Parts' => 'option-62','Other Parts' => 'option-63',]" />
									<x-label_title for="title" class="label-span mt-4 ">Condition</x-label_title>
								...
								<div id="{{ $sub_cat == $subCategories[11]->sub_category_name ? $sub_cat : $subCategories[11]->sub_category_name  }}"
									...
									<!--  trackter  -->
									<x-label_title for="title" class="label-span mt-2">Year</x-label_title>
									<x-input_title type="number" name="year_update[]" class="form-control" />
									<x-label_title for="title" class="label-span mt-2">KM's driven</x-label_title>
									<x-input_number_year type="number" name="kms_driven_no[]" class="form-control" />
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition" :options="['New' => 'option-1','Used' => 'option-2',]" />
								...
								<div id="{{ $sub_cat == $subCategories[12]->sub_category_name ? $sub_cat : $subCategories[12]->sub_category_name  }}"
									...
									<x-condition_tablets_five name="type"
										:options="['Agricultural' => 'option-39', 'Commercial Plots' => 'option-40', 'Files' => 'option-41', 'Industrial Land' => 'option-42', 'Residential Plots' => 'option-43', 'Plot Form' => 'option-44']" />
									...
									<x-condition_tablets_five name="area_unit"
										:options="['Kanal' => 'option-39', 'Marla' => 'option-40', 'Square Feet' => 'option-41', 'Square Meter' => 'option-42', 'Square Yards' => 'option-43']" />
							...
							<x-label_title for="title" class="label-span mt-2 ">Furnished</x-label_title>
								...
								<x-brand_input name="pro_sale_appart_bedroom" :options="['','1', '2', '3', '4', '5', '6', 'Studio']" class="border form-control" placeholder="select bedroom"  />

								<x-label_title for="pro_sale_appart_bathroom" class="label-span mt-2 ">Bathrooms</x-label_title>
								<x-brand_input name="pro_sale_appart_bathroom" :options="['1', '2', '3', '4', '5', '6', '7']" class="border form-control" placeholder="select bathroom" />
								<x-label_title for="title" class="label-span mt-4 ">Floor level</x-label_title>
									<x-brand_input name="pro_sale_appart_floor_level"
								...
								<div id="{{ $sub_cat == $subCategories[20]->sub_category_name ? $sub_cat : $subCategories[20]->sub_category_name  }}"
									...
									<x-label_title for="title" class="label-span mt-4">Feature</x-label_title>
									<x-feature_twelve name="feature"
										:checkboxes="[ ['name' => 'property_parking', 'id' => 'checkbox-89', 'labelClass' => 'checkbox-option-89', 'label' => 'Parking Spaces Available'],['name' => 'property_lobby', 'id' => 'checkbox-90', 'labelClass' => 'checkbox-option-90', 'label' => 'Lobby in Building'],['name' => 'property_double', 'id' => 'checkbox-91', 'labelClass' => 'checkbox-option-91', 'label' => 'Double Glazed Windows'],['name' => 'property_air', 'id' => 'checkbox-92', 'labelClass' => 'checkbox-option-92', 'label' => 'Central Air Conditioning'],['name' => 'property_heating', 'id' => 'checkbox-93', 'labelClass' => 'checkbox-option-93', 'label' => 'Central Heating'],['name' => 'property_electricity', 'id' => 'checkbox-94', 'labelClass' => 'checkbox-option-94', 'label' => 'Electricity Backup'],['name' => 'property_waste', 'id' => 'checkbox-95', 'labelClass' => 'checkbox-option-95', 'label' => 'Waste Disposal'],['name' => 'property_elevators', 'id' => 'checkbox-96', 'labelClass' => 'checkbox-option-96', 'label' => 'Elevators']]" />
									<x-label_title for="title" class="label-span mt-4 ">Floor level</x-label_title>
								...
								<div id="{{ $sub_cat == $subCategories[24]->sub_category_name ? $sub_cat : $subCategories[24]->sub_category_name  }}"
									...
									<x-label_title for="title" class="label-span mt-2 ">Type</x-label_title>
									<x-condition_tablets_five name="type"
										:options="['Agricultural Land' => 'option-20','Commercial Plots' => 'option-21','Industrial Land' => 'option-21','Residential Plotss' => 'option-21',]" />
									<x-label_title for="title" class="label-span mt-4">Feature</x-label_title>
									<x-feature_twelve name="feature"
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[4]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[4]->sub_category_name_type  }}"
									...
									<div class="tab-content border bg-light border-0" id="nav-tabContent"
										...
										<div class="tab-pane fade " id="tab-1" role="tabpanel"
											...
											<x-label_title for="title" class="label-span mt-2 ">Year</x-label_title>
												<x-input_title type="number" name="year_update[]"
												...
												<x-bedroom_one name="engine_capacity"
													:options="['Selected','70cc', '50cc', '100cc - 149cc', 'Above 1000cc', '150cc - 199cc', '50cc', '70cc']"
													class="border form-control" />
												<x-label_title for="title" class="label-span mt-2 ">Km's
													driven</x-label_title>
												<x-input_title type="number" name="kms_driven_no[]"
													class="form-control border-0 ps-0 "
													aria-label="Sizing example input"
													aria-describedby="inputGroup-sizing-sm" />
												...
												<x-bedroom_one name="registration_city"
													:options="['Selected','Unregistered', 'Lahore', 'Islamabad', 'Faisalabad', 'Abbottabad', 'Ahmadpur East',]"
													class="border form-control" />
										</div>
										...
										<div class="tab-pane fade " id="tab-6" role="tabpanel"
											...
											<x-label_title for="title" class="label-span mt-2 ">Year</x-label_title>
											<x-input_title type="number" name="year_update[]" class="form-control border-0 ps-0 "
												aria-label="Sizing example input"
												aria-describedby="inputGroup-sizing-sm" />
											...
											<x-label_title for="title" class="label-span mt-2 ">KM'S
												driven</x-label_title>
											<x-input_title type="number" name="kms_driven_no[]" class="form-control border-0 ps-0 "
												aria-label="Sizing example input"
												aria-describedby="inputGroup-sizing-sm" />
											<x-label_title for="title" class="label-span mt-2 ">Ignition
												type</x-label_title>
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[5]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[5]->sub_category_name_type  }}"
									...
									<x-bedroom_one name="make_car"
										:options="['Selected','Suzuki', 'Toyota', 'Honda', 'Daihatsu', 'Adam', 'Audi', 'BAIC', 'Bentley', 'BMW', 'Buick', 'Cadilac',]"
										class="border form-control" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[6]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[6]->sub_category_name_type  }}"
									...
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-1','Condition' => 'option-2',]" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[20]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[20]->sub_category_name_type  }}"
									...
									<x-bedroom_one name="product"
										:options="['Selected','Anti Lice', 'Beard Oils', 'Curlers', 'Dryers & Stylers', 'Hair Brushes & Combs', 'Hair Fiber', 'Hair Oils', 'Hair Removers', 'Shampoos & Conditioners', 'Trimmers',]"
										class="border form-control" />
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-1','Used' => 'option-2',]" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[24]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[24]->sub_category_name_type  }}"
									...
									<x-label_title for="title" class="label-span mt-2 ">Make</x-label_title>
									<x-bedroom_one name="make_car"
										:options="['Selected','Speed', 'Morgan', 'Suzuki', 'Sohrab', 'Specialized', 'Sohrab', 'Louis', 'Morgan', 'Specialized', 'Precision',]"
										class="border form-control" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[9]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[27]->sub_category_name_type  }}"
									class="component">
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-1','Condition' => 'option-2',]" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[10]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[28]->sub_category_name_type  }}"
									class="component">
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-1','Condition' => 'option-2',]" />
								...
								<div id="{{ $sub_cat_type == $subCategoryNameTypes[12]->sub_category_name_type ? $sub_cat_type : $subCategoryNameTypes[29]->sub_category_name_type  }}"
									class="component">
									<x-label_title for="title" class="label-span mt-2 ">Condition</x-label_title>
									<x-condition_tablets_five name="condition"
										:options="['New' => 'option-1','Condition' => 'option-2',]" />
								...
								<div class="row">
									...
									<div class="image-container" id="imageContainer">
										<div class="add-photo-icon" id="addPhotoIcon">
											<img src="assets/images/iconAddPhoto_noinline.8924e2486f689a28af51da37a7bda6ec.svg"
												alt="Add Photo">
										</div>
										<input type="file"  name="image_path[]" multiple
											class="file-input" id="fileInput"  accept="image/jpeg, image/png, image/gif, image/svg+xml">
										<input type="file" name="image_path[]" id="hiddenInput" style="display:none;">
										<span class="message-text">
											<span class="input-message">For the cover picture we recommend using the
												landscape mode</span>
										</span>
									</div>
								</div>
								...
								<x-location_city name="location"
									:cities="['Lahore', 'Karachi', 'Faisalabad', 'Rawalpindi', 'Gujranwala', 'Peshawar', 'Multan', 'Hyderabad', 'Islamabad']" />
								@error('location')
								<div class="alert alert-danger">{{ $message }}</div>
								@enderror
								<hr>
								<x-profile :image="'assets/images/Profile-Male-PNG.png'" name="review_name"
									:name="Auth::user()->name" :phone="Auth::user()->phone_no"
