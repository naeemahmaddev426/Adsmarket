    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="user/users_profile">Profile</a></li>
        </ol>
      </nav>
    </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <img src="{{asset('user-panel/assets/img/Profile-Male-PNG.png')}}" alt="Profile" class="rounded-circle">
              @auth
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{asset('user-panel/assets/img/Profile-Male-PNG.png')}}" alt="Profile">
                        <div class="pt-2">
