    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{ route('admin.home_banner') }}">home_banner</a></li>
        </ol>
      </nav>
    </div>
      <div class="container">
        ...
        @endif
          ...
          @endif
            <div class="card p-5">
              <form id="bannerForm" action="{{ route('admin.upload_home_banner') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group mb-3">
                    <label for="banner">Upload Home Banner</label>
